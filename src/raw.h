...
#define RAW_PREVIEW_COLOR_HALFRES   0   /* full colour, half horizontal resolution */
#define RAW_PREVIEW_GRAY_ULTRA_FAST 1   /* legacy grayscale mode */
#define RAW_PREVIEW_COLOR_320P      2   /* full colour, cached ~320-line sampling */
